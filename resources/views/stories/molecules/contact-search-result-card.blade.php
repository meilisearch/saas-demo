...
<x-molecules.contact-search-result-card contact-avatar-url="{{ $contactAvatarUrl }}" contact-full-name="{{ $contactFullName }}" contact-company-name="{{ $contactCompanyName }}" contact-email="{{ $contactEmail }}" contact-phone-number="{{ $contactPhoneNumber }}">
