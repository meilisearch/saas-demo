@storybook([
    'name' => 'Sample Result Modal',
    'args' => [
        'href' => '#',
        'dealStatus' => 'lead',
        'companyName' => 'Meilisearch',
        'dealCompanyName' => 'Uber',
        'value' => '$3000',
        'dealOwner' => 'Jane Doe',
...
<x-molecules.search-modal>
    <x-molecules.deal-search-result-card href="{{ $href }}" dealStatus="{{ $dealStatus }}" companyName="{{ $dealCompanyName }}" value="{{ $value}}" dealOwner="{{ $dealOwner }}" dealProspect="{{ $dealProspect }}"></x-molecules.deal-search-result-card>
    <x-molecules.contact-search-result-card href="{{ $href }}" contact-avatar-url="{{ $contactAvatarUrl }}" contact-full-name="{{ $contactFullName }}" contact-company-name="{{ $contactCompanyName }}" contact-email="{{ $contactEmail }}" contact-phone-number="{{ $contactPhoneNumber }}"></x-molecules.contact-search-result-card>
    <x-molecules.company-search-result-card href="{{ $href }}" companyName="{{ $companyName }}" companyLogoUrl="{{ $companyLogoUrl}}" associatedContactsNumber="{{ $associatedContactsNumber }}"></x-molecules.company-search-result-card>
</x-molecules.search-modal>
